...
1. [Classification by Structure](#classification-by-structure)
2. [Classification by Collection Method](#classification-by-collection-method)
3. [Classification by Size and Complexity](#classification-by-size-and-complexity)
4. [Classification by Access Type](#classification-by-access-type)
5. [Classification by Purpose](#classification-by-purpose)
6. [Classification by Format](#classification-by-format)
